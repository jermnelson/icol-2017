...
function pushAnimation() {
    ...
    var pushStep1 = function() {
        ...
        step_desc = push.text(title_x, 85, "Raw steel panels transported to assembly line ");
    ...
    var pushStep3 = function() { 
        ...
        step_desc.attr({  text: "Car is moved to final step",
                             x: title_x,
                             y: 180 });
        car_grp2.animate({ transform: "t-350,0,s1.25"}, 2000);
        tires2_grp.animate({ transform: "t-135,-80"  }, 2000, function() {
           tires2_grp.attr({ filter: blur });
           car_grp2.attr({ filter: blur });
